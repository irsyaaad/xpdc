...
var Stt = (function () {
    ...
    var handleDeleteRows = function () {
        ...
        tableData.on('click', '.btn-edit', function (e) {
            ...
            $("#_method").val("PUT");
            $("#nm_perush_asuransi").val(data.nm_perush_asuransi);
            $("#jenis_asuransi").val(data.jenis_asuransi).trigger('change');
            $("#jenis_resiko").val(data.jenis_resiko).trigger('change');
