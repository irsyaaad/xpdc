...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px py-4"
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="symbol symbol-50px me-5">
                <img alt="Logo" src="{{ asset('assets-templatev2/media/avatars/300-2.jpg') }}" />
            </div>
            <!--end::Avatar-->
            <!--begin::Username-->
            <div class="d-flex flex-column">
                <div class="fw-bold d-flex align-items-center fs-5">
                    Jane Cooper <span class="badge badge-light-success fw-bold fs-8 ms-2 px-2 py-1">Pro</span>
                </div>
    ...
    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
        ...
        @include('templatev2.partials.theme-mode.__menu')
    </div>
    <!--end::Menu item-->
    <!--begin::Menu item-->
    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
            ...
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 bg-light position-absolute translate-middle-y top-50 end-0 rounded px-3 py-2">
                    English <img class="w-15px h-15px rounded-1 ms-2"
                        src="{{ asset('assets-templatev2/media/flags/united-states.svg') }}" alt="" />
                </span>
            </span>
        </a>
        <!--begin::Menu sub-->
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="?page=account/settings" class="menu-link d-flex active px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('assets-templatev2/media/flags/united-states.svg') }}"
                            alt="" />
                    </span>
                    English
                </a>
            ...
            <div class="menu-item px-3">
                <a href="?page=account/settings" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('assets-templatev2/media/flags/spain.svg') }}"
                            alt="" />
                    </span>
                    Spanish
                </a>
            ...
            <div class="menu-item px-3">
                <a href="?page=account/settings" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('assets-templatev2/media/flags/germany.svg') }}"
                            alt="" />
                    </span>
                    German
                </a>
            ...
            <div class="menu-item px-3">
                <a href="?page=account/settings" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('assets-templatev2/media/flags/japan.svg') }}"
                            alt="" />
                    </span>
                    Japanese
                </a>
            ...
            <div class="menu-item px-3">
                <a href="?page=account/settings" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('assets-templatev2/media/flags/france.svg') }}"
                            alt="" />
                    </span>
                    French
                </a>
