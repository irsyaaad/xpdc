            ...
            <div class="modal-body pb-15 px-xl-20 px-5 pt-0">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="nav-group nav-group-outline mx-auto" data-kt-buttons="true">
                        <button class="btn btn-color-gray-500 btn-active btn-active-secondary active me-2 px-6 py-3"
                            data-kt-plan="month">
                            Monthly
                        </button>
                                ...
                                <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 flex-grow-1 text-gray-700">
                ...
                <div class="d-flex flex-center flex-row-fluid pt-12">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_modal_upgrade_plan_btn">
                        ...
                        @include('templatev2.partials.general._button-indicator')
                    </button>
                </div>
                <!--end::Actions-->
            </div>
