...
<div class="col-md-3">
	...
	<select class="form-control" id="f_penerima" name="f_penerima">
...
<div class="col-md-6" style="margin-top:30px">
	...
	{{-- <a href="{{ url(Request::segment(1)."/import") }}" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Import Booking</a> --}}
