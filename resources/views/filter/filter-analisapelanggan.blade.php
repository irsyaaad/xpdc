                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3 row" style="padding-top:30px;">
                        <button class="btn btn-md btn-primary" data-toggle="tooltip" data-placement="bottom"
                            title="Cari Data" style="margin-right : 5px"><span><i
                                    class="fa fa-search"></i></span></button>
                        <a href="{{ url(Request::segment(1)) }}" class="btn btn-md btn-warning" data-toggle="tooltip"
                            data-placement="bottom" title="Refresh Data" style="margin-right : 5px"><span><i
                                    class="fa fa-refresh"></i></span></a>
                        <a href="{{ route('cetak-analisa-pelanggan', [
                            'dr_tgl' => $filter['dr_tgl'],
                            'sp_tgl' => $filter['sp_tgl'],
                        ]) }}"
                            class="btn btn-md btn-info" data-toggle="tooltip" data-placement="bottom" title="Cetak Pdf"
                            target="_blank" style="margin-right : 5px"><span><i class="fa fa-print"></i></span></a>
                        <a href="{{ route('excel-analisa-pelanggan', [
                            'dr_tgl' => $filter['dr_tgl'],
                            'sp_tgl' => $filter['sp_tgl'],
                        ]) }}"
                            class="btn btn-md btn-success" data-toggle="tooltip" data-placement="bottom" title="Cetak Excel"
                            target="_blank"><span><i class="fa fa-file"></i></span></a>
                    </div>
