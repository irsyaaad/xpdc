			...
			<div class="col-xl-12">
				<div class="form-group row">
					...
					<div class="col-md-3 row" style="padding-top:30px;">
						<button class="btn btn-md btn-primary mr-2" data-toggle="tooltip" data-placement="bottom" title="Cari Data"><span><i class="fa fa-search"></i></span></button>
						...
						<a href="{{ route('cetak-prestasi-penagihan', [
