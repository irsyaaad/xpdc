			...
			<div class="col-xl-12">
				<div class="form-group row">
					...
					<div class="col-md-3 row" style="padding-top:30px;">
						...
						<a href="{{ route('cetak-bygrouppelanggan', [
                            'dr_tgl' => $filter['dr_tgl'], 
                            'sp_tgl' => $filter['sp_tgl'],
                            ]) }}" class="btn btn-md btn-success" data-toggle="tooltip" data-placement="bottom" title="Cetak"><span><i class="fa fa-print"></i></span></a>
					</div>					
				</div>
			</div>
		</div>
