...
<div id="print-kan">
    ...
    <div class="container" style="margin-top:20px">
        <div>
            <p class="text-center"><b>Bukti Kas / Bank Masuk</b></p>
        </div>
        <table class="atas" width="100%">
            <tr>
                <td width="15%">No. Transaksi</td>
                <td width="2%"> : </td>
                <td>{{ $data->kode_pendapatan }}</td>
            </tr>
            <tr>
                <td>Tgl. Masuk</td>
                <td> : </td>
            ...
            <tr>
                ...
                <td> : </td>
                <td>@if(isset($data->user->nm_user)){{ $data->user->nm_user }}@endif</td>
            </tr>
        </table>
        <br>
    ...
    <table width="100%">
        ...
        <tr class="text-center">
            ...
            <td width="25%">@if(isset($data->karyawan->nm_karyawan)){{ $data->karyawan->nm_karyawan }}@endif</td>
