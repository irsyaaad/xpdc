...
@if((Request::segment(1)=="settinghandling" or Request::segment(1)=="settinghandlingperush") and Request::segment(2)==null)
@if(Request::segment(1)=="settinghandlingperush")
...
<form method="POST" action="@if(Request::segment(2)=="create"){{ url(Request::segment(1)) }}@else{{ url(Request::segment(1), $data->id_setting) }}@endif" enctype="multipart/form-data">
    ...
    @endif
    @csrf
    @include('keuangan::settinghandling.create')
