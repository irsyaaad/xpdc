        ...
        <table class="table table-hover" style="margin-top: 5px">
            <tbody>
                ...
                <tr>
                    <td>No. Transaksi</td>
                    <td> : </td>
                    <td><b>{{ $data->kode_pengeluaran }}</b></td>
                    ...
                    <td>Tgl. Masuk</td>
                    <td> : </td>
                    <td><b>@if(isset($data->tgl_keluar)){{ daydate($data->tgl_keluar).", ".dateindo($data->tgl_keluar) }}@endif</b></td>
                </tr>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="margin-left: 10%; font-weight: bold;"><span><i class="fa fa-money"></i></span> Form Tambah Detail Pengeluaran</h4>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ url(Request::segment(1)."/savedetail") }}" id="form-detail" name="form-detail">
                        @csrf
                        <input type="hidden" name="id_pengeluaran" id="id_pengeluaran" value="{{ Request::segment(2) }}" required />
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_ac" required id="id_ac">
