...
<head>
    ...
    <title>RUGILABA KONSOLIDASI</title>
</head>
<?php
	header("Content-type: application/vnd-ms-excel");
	header("Content-Disposition: attachment; filename=rugilaba-konsolidasi.xls");
?>
...
<div class="container"  style=" margin-top:10px;">
	<table>
		...
		<tr>
		<th colspan="5" class="text-center">LAPORAN RUGILABA KONSOLIDASI</th>
		</tr>
		<tr>
