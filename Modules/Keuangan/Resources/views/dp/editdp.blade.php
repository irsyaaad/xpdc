...
<form method="POST" action="{{ url(Request::segment(1), $dp->id_dp) }}" enctype="multipart/form-data">
    {{ method_field("PUT") }}
        @csrf
    <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <input class="form-control" type="date" id="tgl_dp" name="tgl_dp" placeholder="Tanggal Dp" maxlength="16" value="@if(isset($dp->tgl_dp)){{$dp->tgl_dp}}@endif" />
        ...
        <div class="col-md-3">
            ...
            <input class="form-control" type="number" id="n_dp" name="n_dp" placeholder="Jumlah Dp" maxlength="24" value="@if(isset($dp->n_dp)){{$dp->n_dp}}@endif"/>
        ...
        <div class="col-md-3">
            ...
            <textarea class="form-control" id="info_dp" name="info_dp" placeholder="Info Dp" maxlength="124"
                style="min-height: 100px"> @if(isset($dp->info_dp)){{ $dp->info_dp }}@endif</textarea>
