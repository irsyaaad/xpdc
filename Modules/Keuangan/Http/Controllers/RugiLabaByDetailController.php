...
class RugiLabaByDetailController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $data["data"]       = $temp;
        $data["ac"]         = $ac;
        $pdf = url("rugilabadetail")."/cetak/pdf?_token=".$request->_token."&dr_tgl=".$dr_tgl."&sp_tgl=".$sp_tgl;
        $excel = url("rugilabadetail")."/cetak/excel?=_token=".$request->_token."&dr_tgl=".$dr_tgl."&sp_tgl=".$sp_tgl;
        ...
        return view('keuangan::laporan.rugilababyperkiraan',$data);
    }
    ...
    public function cetak(Request $request)
    {
        ...
        $back = url("rugilabadetail")."?=_token=".$request->_token."&dr_tgl=".$dr_tgl."&sp_tgl=".$sp_tgl;
        ...
        // return view('keuangan::laporan.cetak-rugilabadetail',$data);

        $pdf = \PDF::loadview("keuangan::laporan.cetak.rugilaba-detail",$data)
