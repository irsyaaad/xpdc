...
<head>
    ...
    <title>Daftar Gaji {{$bulan}}/{{$tahun}}</title>
    <style>
        @media print{
            @page {
                size: A4 landscape;
    ...
    @php $nm_perush = $bulan."/".$tahun; @endphp
    <?php
    header("Content-type: application/vnd-ms-excel");
    header("Content-Disposition: attachment; filename=Daftar Gaji".$nm_perush.".xls");
    ?>
</head>
        ...
        <table class="table table-sm table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @php
                    $gj = $value->n_gaji * 0.55;
                    $tj = $value->n_gaji * 0.25;
                    $to = $value->n_gaji * 0.1;
                    $tk = $value->n_gaji * 0.1;
                    $thp = $value->n_gaji-$value->n_denda;
                    $total_gaji_pokok += $gj;
                    $total_tuj_jab += $tj;
                    $total_tuj_ops += $to;
                    $total_tuj_keh += $tk;
                    ...
                    <td>@if(isset($to)){{ tonumber($to) }}@endif</td>
                ...
                <tr>
                    ...
                    <td>Rp. {{tonumber($total_tuj_ops)}}</td>
