...
<head>
    ...
    <title>Laporan Statistik Kehadiran Karyawan</title>
    <style>
        @media print{
            @page {
                size: F4 portrait;
...
header("Content-Disposition: attachment; filename=StatisikKehadiaran".$perusahaan->nm_perush.date("my").".xls");
?>
<body>
                    ...
                    <table class="table table-responsive table-bordered" id="mytable" width="100%">
                        <thead style="background-color: #fff; color : black">
                            <tr style="border: 1px solid black;">
                                ...
                                <th rowspan="2" style="border: 1px solid black;">Kehadiran</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-garis">{{ $izin[$value->id_karyawan][$value1->id_jenis]->ijin }}</td>
                                @php
