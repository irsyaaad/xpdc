<script type="text/javascript">
    ...
    $("#n_berat").val('{{ $data->est_berat }}');
    $("#n_volume").val('{{ $data->est_volume }}');
    $("#n_kubik").val('{{ $data->est_kgv }}');
    $("#n_koli").val('{{ $data->est_koli }}');
    ...
    $("#id_pelanggan").val('{{ $id_pelanggan }}').trigger("change");
    @endif
    ...
    @if(isset($asal->id_wil))
    $("#pengirim_id_region").empty();
    $("#pengirim_id_region").append('<option value=' + {{ $asal->id_wil }} + '>'+"{{ strtoupper($asal->nama_wil) }}"+'</option>');
    @endif
    
    @if(isset($tujuan->id_wil))
    $("#penerima_id_region").empty();
    $("#penerima_id_region").append('<option value=' + {{ $tujuan->id_wil }} + '>'+"{{ strtoupper($tujuan->nama_wil) }}"+'</option>');
    @endif
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $.each(response,function(key, value)
                    {
                        ...
                        //$("#id_cr_byr_o").append('<option value=' + 'tes' + '>' + 'tes	' + '</option>');
                    });
                },
                error: function (xhr, ajaxOptions, thrownError) {
                    console.log(thrownError);
