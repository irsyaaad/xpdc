...
<div class="div pt-1 row">
    <div class="col-md-2 col-lg-2 col-sm-2 pt-3">
        Jumlah Data : <b>{{ $data->total() }}</b>
    </div>

    <div class="col-md-2 col-lg-2 col-sm-2">
        <select class="form-select" style="font-weight: bold;" id="shareselect" name="shareselect">
    ...
    @if ($data->hasPages())
        <div class="col-md-12 col-lg-12 col-sm-12 pt-4 d-flex text-left px-0">
