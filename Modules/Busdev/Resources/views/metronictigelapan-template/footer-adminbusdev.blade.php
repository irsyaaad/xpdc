...
<script src="{{ url('assets-adminbusdev/plugins/custom/fullcalendar/fullcalendar.bundle.js') }}"></script>
...
<script src="{{ url('assets-adminbusdev/plugins/custom/datatables/datatables.bundle.js') }}"></script>
<!--end::Vendors Javascript-->
<!--begin::Custom Javascript(used for this page only)-->
<script src="{{ url('assets-adminbusdev/js/widgets.bundle.js') }}"></script>
<script src="{{ url('assets-adminbusdev/js/custom/widgets.js') }}"></script>
<script src="{{ url('assets-adminbusdev/js/custom/apps/chat/chat.js') }}"></script>
<script src="{{ url('assets-adminbusdev/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
<script src="{{ url('assets-adminbusdev/js/custom/utilities/modals/users-search.js') }}"></script>
