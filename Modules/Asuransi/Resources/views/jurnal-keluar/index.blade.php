                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ url(Request::segment(1)) . '/' . $value->id_pengeluaran . '/show' }}"
                                                class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ strtoupper($value->kode_pengeluaran) }}</a>
                                            <span
                                                class="badge badge-light-success fs-8 fw-bold">{{ isset($value->tgl_keluar) ? dateindo($value->tgl_keluar) : '' }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="menu menu-rounded menu-column menu-gray-600 menu-state-bg fw-semibold"
                                        ...
                                        <div class="menu-item" data-kt-menu-trigger="hover"
                                            ...
                                            <div class="menu-sub menu-sub-dropdown p-3 w-200px">
                                                <div class="menu-item">
                                                    <a href="{{ url(Request::segment(1) . '/' . $value->id_pengeluaran . '/edit') }}"
                                                ...
                                                <div class="menu-item">
                                                    <a href="#" class="menu-link px-1 py-3 btn-delete" type="button"
                                                        data-url="{{ url(Request::segment(1)) . '/' . $value->id_pengeluaran }}">
                                                        <span class="menu-bullet me-2">
