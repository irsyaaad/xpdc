                            ...
                            @foreach ($data as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="text-muted fw-semibold text-muted d-block fs-7">
                                            {{ isset($value->asuransi->pelanggan->nm_perush) ? $value->asuransi->pelanggan->nm_perush : ' ' }}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="text-dark fw-bold d-block mb-1 fs-6">
                                    ...
                                    <td class="text-end">
                                        <a href="javascript:void(0)" title="Edit" class="btn btn-sm btn-warning btn-edit"
                                            ...
                                            data-id-perush-asuransi="{{ $value->id_perush_asuransi }}"
                                            data-tgl-bayar="{{ $value->tgl_bayar }}"
                                            data-id-asuransi="{{ $value->id_asuransi }}"
                                            data-url="{{ url(Request::segment(1), $value->id_asuransi_biaya_pay) }}">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            <form class="form" novalidate="novalidate" method="POST"
                                ...
                                <input type="hidden" name="id_perush_asuransi" id="id_perush_asuransi" value="">
