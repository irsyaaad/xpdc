                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ url(Request::segment(1)) . '/' . $value->id_memorial . '/show' }}"
                                                class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ strtoupper($value->kode_memorial) }}</a>
                                            <span
                                                class="badge badge-light-success fs-8 fw-bold">{{ isset($value->tgl) ? dateindo($value->tgl) : '' }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <a href="javascript:void(0)"
                                        class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ isset($value->kredit->nama) ? ucwords(strtolower(' ( ' . $value->kredit->id_ac . ' ) ' . $value->kredit->nama)) : '-' }}</a>
                                </td>
                                <td>
                                    <span class="text-muted fw-semibold text-muted d-block fs-7">
                                        {{ isset($value->user->nm_user) ? $value->user->nm_user : '-' }}
                                    </span>
                                </td>
                                <td>
                                    <a href="javascript:void(0)"
                                        class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ isset($value->nominal) ? toRupiah($value->nominal) : '' }}</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)"
                                    ...
                                    <div class="menu menu-rounded menu-column menu-gray-600 menu-state-bg fw-semibold"
                                        ...
                                        <div class="menu-item" data-kt-menu-trigger="hover"
                                            ...
                                            <div class="menu-sub menu-sub-dropdown p-3 w-200px">
                                                <div class="menu-item">
                                                    <a href="{{ url(Request::segment(1) . '/' . $value->id_memorial . '/edit') }}"
                                                ...
                                                <div class="menu-item">
                                                    <a href="#" class="menu-link px-1 py-3 btn-delete" type="button"
                                                        data-url="{{ url(Request::segment(1)) . '/' . $value->id_memorial }}">
                                                        <span class="menu-bullet me-2">
